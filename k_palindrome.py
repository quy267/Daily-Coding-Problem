...
Thus we are building the palindrome from the inside out by trying to match all characters at the ends, ignoring characters that don't help. This will take O(N2) time and space.
"""
...
print(k_palindrome(s='waterrfetawx', k=2))
